...
import (
	...
	"github.com/pastelnetwork/gonode/supernode/node/init/server"
	...
	"github.com/pastelnetwork/gonode/supernode/services/pastelmail/mailservice"
)
...
func runApp(ctx context.Context, config *configs.Config) error {
	...
	go server.StartSubscribe(pastelMail, nc)
